...
<img :src="$withBase('/img/css/04.png')" alt="图片" width="200px">  
...
<img :src="$withBase('/img/css/05.png')" alt="图片">  
...
<img :src="$withBase('/img/css/06.png')" alt="图片">  
...
<img :src="$withBase('/img/css/07.png')" alt="图片">  
...
<img :src="$withBase('/img/css/08.png')" alt="图片" width="600px">


可以看到，落败的作者样式在 *Elements>Styles* 中会被划掉。

有关选择器权重的计算方式，不清楚的同学，可以进入此传送门：[权重的计算方式](https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity)
...
<img :src="$withBase('/img/css/09.png')" alt="图片" width="600px">
...
<img :src="$withBase('/img/css/10.png')" alt="图片" width="600px">
...
```
<img :src="$withBase('/img/css/11.png')" alt="图片" width="600px">
...
<img :src="$withBase('/img/css/12.png')" alt="图片" width="600px">
...
<img :src="$withBase('/img/css/13.png')" alt="图片" width="600px">
...
<img :src="$withBase('/img/css/14.png')" alt="图片" width="600px">
