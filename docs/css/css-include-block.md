...
[包含块containing block](https://drafts.csswg.org/css2/#containing-block-details)
...
<img :src="$withBase('/img/css/15.png')" alt="图片" width="600px">
...
公布正确答案：
<img :src="$withBase('/img/css/16.png')" alt="图片" width="600px">
...
<img :src="$withBase('/img/css/17.png')" alt="图片" width="600px">
...
具体你可以移步到：[MDN包含块](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Containing_block)
